...
def random_number():
    ...
    true_friend["text"] = "your true friend is:  " + str(generated_random_number)
...
btn1 = Button(root, text = "Who is your True Friend?", command = random_number)
